...
<body>
    <table class="table">
        ...
        <tr>
            <td>Size | <button type="button" class="btn btn-light">S</button> | <button type="button" class="btn btn-light">M</button> | <button type="button" class="btn btn-light">L</button> | <button type="button" class="btn btn-danger">Light</button></td>
        </tr>
        <tr>
