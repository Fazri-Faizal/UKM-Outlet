<?php 
    ...
    foreach($arr as $collegelist) { 
        ...
        $collegeName = $collegelist['college_Name'];
            ...
            ?>
                ...
                <form action="/product-details" method="get">
                        ...
                        <div class="card">
                            ...
                            <img src="/img/<?php echo $collegelist['pic'] ?>" alt="Denim Jeans" style="width: 206px; height: 264px;">
                            <p style="margin-left: 230px; margin-right: 5px;">
                                ...
                                </svg> <?php echo $collegelist['product_Rating'] ?>
                            </p>
                            <h3><?php echo $collegelist['product_Name'] ?></h3>
