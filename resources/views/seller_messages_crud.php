...
if (isset($_GET['sendmessage'])) {
        ...
        $stmt2 = $conn->prepare("INSERT INTO tbl_chatlog(username,chat,date_time,chat_with,currentid) VALUES(:un,:chat,NOW(),:chatwith,:cid)");
        ...
        echo "<script>
         ...
         window.location.href='\seller_messages_crud'; 
